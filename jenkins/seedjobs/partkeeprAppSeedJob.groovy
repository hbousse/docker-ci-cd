def gitUrl = 'https://github.com/hbousse/PartKeepr'

createCiJob("partkeepr-app", gitUrl, "app/pom.xml")
createSonarJob("parkeepr", gitUrl, "app/pom.xml")
createDockerBuildJob("parkeepr", "app")
createDockerStartJob("parkeepr", "app", "48080")
createDockerStopJob("parkeepr", "app")

createCiJob("parkeepr-monitoring", gitUrl, "monitoring/pom.xml")
createSonarJob("parkeepr-monitoring", gitUrl, "monitoring/pom.xml")
createDockerBuildJob("parkeepr-monitoring", "monitoring")
createDockerStartJob("parkeepr-monitoring", "monitoring", "58080")
createDockerStopJob("parkeepr-monitoring", "monitoring")
